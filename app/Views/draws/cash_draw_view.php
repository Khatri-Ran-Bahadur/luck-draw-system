...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="<?= base_url('cash-draws') ?>" class="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium">
        ...
        <div class="bg-gradient-to-r from-green-500 to-blue-600 rounded-2xl shadow-lg p-8 text-white mb-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="text-center">
                    <div class="text-2xl font-bold">Rs. <?= number_format($draw['prize_amount'], 2) ?></div>
                    <div class="text-sm opacity-80">Total Prize</div>
                </div>
                <div class="text-center">
                    <div class="text-2xl font-bold"><?= $draw['total_winners'] ?></div>
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="mt-8">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php if ($draw['status'] === 'active'): ?>
                                                <form action="<?= base_url('cash-draw/enter/' . $draw['id']) ?>" method="post" class="space-y-4">
                                                    <?= csrf_field() ?>
                                                    ...
                                                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-6">
                                                        <div class="flex items-center justify-between">
                                                            ...
                                                            <div class="text-right">
                                                                ...
                                                                <p class="font-semibold text-gray-900">Rs. <?= number_format($draw['prize_amount'], 2) ?></p>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <button type="submit" class="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <div class="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center">
                                                    ...
                                                    <h3 class="text-lg font-semibold text-gray-900">Draw Not Active</h3>
                                                    <p class="text-gray-600">This cash draw is currently not available for entries.</p>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between py-3 border-b border-gray-100">
                            ...
                            <span class="font-semibold text-green-600">Rs. <?= number_format($draw['prize_amount'], 2) ?></span>
                        </div>
                        <div class="flex items-center justify-between py-3 border-b border-gray-100">
                            <span class="text-gray-600">Number of Winners:</span>
                            <span class="font-semibold text-gray-900"><?= $draw['total_winners'] ?></span>
                        </div>
                        <div class="flex items-center justify-between py-3 border-b border-gray-100">
