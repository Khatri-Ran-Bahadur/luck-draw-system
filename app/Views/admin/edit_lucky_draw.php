...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <form action="<?= base_url('admin/lucky-draws/edit/' . $draw['id']) ?>" method="post" class="p-6 space-y-6" id="editLuckyDrawForm">
            <?= csrf_field() ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Form validation
    const form = document.getElementById('editLuckyDrawForm');
