...
<div class="space-y-8">
    ...
    <div class="bg-gradient-to-r from-green-600 to-emerald-700 rounded-2xl shadow-lg p-8 text-white">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-3xl font-bold">Approve Top-up Request</h1>
                <p class="text-green-100 text-lg mt-1">Review and approve special user top-up request</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-green-600">Rs. <?= number_format($request['amount'], 2) ?></p>
            </div>
    ...
    <!-- Approval Form -->
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
        <h2 class="text-xl font-semibold text-gray-900 mb-6">Approve Request</h2>

        <form action="<?= base_url('admin/approve-topup-request/' . $request['id']) ?>" method="POST">
            <div class="mb-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <button type="submit" class="inline-flex items-center px-8 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-xl transition-colors">
